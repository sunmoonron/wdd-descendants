# Atlas of the WDD program: 479 experiments by technical area
...
- **Scale.** 479 experiment scripts (e00-e515 plus variants), 71 sessions, 2026-09-19 to 2026-09-25, one GPU. Most runs take 1-5 minutes.
- **Status counts** (from [`atlas/index.tsv`](atlas/index.tsv)): 126 established, 108 supported, 63 narrowed, 28 mixed, 124 refuted, 12 superseded, 8 null, 4 retracted, 6 tools.
...
- **Narrative.**
  ...
  - [`GRAPH.md`](GRAPH.md): hypotheses H0-H355 with their tests and fates.
