# Atlas of the WDD program: 460 experiments by technical area
...
- **Scale.** 460 experiment scripts (e00-e497 plus variants), 61 sessions, 2026-09-19 to 2026-09-25, one GPU. Most runs take 1-5 minutes.
- **Status counts** (from [`atlas/index.tsv`](atlas/index.tsv)): 121 established, 106 supported, 57 narrowed, 27 mixed, 120 refuted, 12 superseded, 8 null, 4 retracted, 5 tools.
...
20. Calibrated against classical theory, WDD is a detector with a known threshold law.
    ...
    - The provenance factor is write sparsity on an accent: the largest writes standing out (rising through training) over a collective alignment present from step 1000 (e493). A learned SAE feature has an MLP row as its top native word in 93% of cases and needs many rows; a quarter of the most used rows are features (e494), at every depth (e495); its firing follows its rows' activity partly, AUC 0.62 for the top row and 0.70 for the eight-word ledger (e496). The accent forms by Pythia step 512, the words from step 1000 (e492, e493). A feature is as sparse in native words as a whole state, far sparser than a random or covariance-matched direction: state-like, not write-like (e497). [20]
...
- **Narrative.**
  ...
  - [`GRAPH.md`](GRAPH.md): hypotheses H0-H328 with their tests and fates.
...
- **Sessions to experiments.**
  ...
  - Phase 3:
    ...
    - S40 e415-e420; S41 e421-e422; S42 e421b, e423-e426; S43 e427-e431; S44 e432-e443 with e392b and e437b; S45 e444-e450; S46 e451-e455 with e452b; S47 e456-e459; S48 e460-e461; S49 e462; S50 e463-e464; S51 e465; S52 e466-e469; S53 e470; S54 e471; S55 e472-e475; S56 e476-e477; S57 e478-e482 with e478b; S58 e483-e492; S59 e493-e494; S60 e495-e496; S61 e497.
