# Atlas of the WDD program: 477 experiments by technical area
...
- **Scale.** 477 experiment scripts (e00-e514 plus variants), 70 sessions, 2026-09-19 to 2026-09-25, one GPU. Most runs take 1-5 minutes.
- **Status counts** (from [`atlas/index.tsv`](atlas/index.tsv)): 126 established, 108 supported, 62 narrowed, 28 mixed, 124 refuted, 12 superseded, 8 null, 4 retracted, 5 tools.
...
- **Narrative.**
  ...
  - [`GRAPH.md`](GRAPH.md): hypotheses H0-H353 with their tests and fates.
