...
| Internals interoperable through word-level translation tables | two models' words correspond one to one | e445 (Pythia 160m, 410m, 1b) | **Refuted at the word level.** Word-for-word translation keeps 0.06-0.13 of function against 0.85-0.91 for a dense linear map. Partner words exist above chance (7-14% against 1-2%). Interoperability will be dense. |
